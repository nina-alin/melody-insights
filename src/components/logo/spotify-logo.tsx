const SpotifyLogo = (props: { className?: string }) => (
  <svg
    width={40}
    height={40}
    aria-labelledby="spotify-native-app-logo-icon"
    viewBox="0 0 192 192"
    {...props}
  >
    <title data-testid="native-app-icon-title">{"Appli Spotify Mobile"}</title>
    <path
      fill="#1ed760"
